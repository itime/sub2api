...
func (s *accountRepoStub) CountStatusSummary(ctx context.Context, platform, accountType, search string, groupID int64, privacyMode string) (map[string]int64, error) {
	panic("unexpected CountStatusSummary call")
}
