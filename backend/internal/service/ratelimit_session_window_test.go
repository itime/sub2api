...
func (m *sessionWindowMockRepo) CountStatusSummary(context.Context, string, string, string, int64, string) (map[string]int64, error) {
	panic("unexpected")
}
func (m *sessionWindowMockRepo) FindIDByEmail(context.Context, string) (int64, error) {
	panic("unexpected")
}
func (m *sessionWindowMockRepo) SetCreatedAt(context.Context, int64, time.Time) error {
	panic("unexpected")
}
func (m *sessionWindowMockRepo) GetCreatedAndUpdatedAt(context.Context, int64) (time.Time, time.Time, error) {
	panic("unexpected")
}
